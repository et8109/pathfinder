...
class Database:
    ...
    def reset():
        ...
        #up 2
        z3 = Zone(zid=3)
        z3.paths.append(Path(dirt=Dirt.down.value,dest=2,audio=""))
        z3.paths.append(Path(dirt=Dirt.right.value,dest=4,audio="door.mp3"))
        z3.save()

        #up2 r1
        z4 = Zone(zid=4)
        z4.npcs.append(Man(zid=4))
        z4.paths.append(Path(dirt=Dirt.left.value,dest=3,audio="door.mp3"))
        z4.save()
